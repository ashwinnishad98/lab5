...
#define WIFI_PASSWORD "$+=}gu3iUA"

// Insert Firebase project API Key
#define API_KEY "AIzaSyBIWjdLqFsLTrOCKw_vMmI3MWJEY9Dn-G0"
// Insert RTDB URLefine the RTDB URL */
#define DATABASE_URL "https://lab5-e6936-default-rtdb.firebaseio.com/"
...
void sendDataToFirebase(float distance)
{
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > uploadInterval || sendDataPrevMillis == 0))
  {
    ...
    if (Firebase.RTDB.pushFloat(&fbdo, "lab5/profiler", distance))
    {
